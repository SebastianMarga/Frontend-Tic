      ...
      <div className="modal-content modal-lg" id="modal-detalle-producto">
        <div className="modal-header">
          ...
          <button
            ...
            onClick={onClose}
            id="btn-cerrar-detalle-producto"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="modal-body">
          ...
          >
            ...
            >
              ...
              <div
                className="mono"
                style={{ fontSize: "20px", fontWeight: 800, marginTop: "2px" }}
              >
            ...
            >
              ...
              >
                {product.dynamicThreshold?.toLocaleString()}{" "}
                {product.unit || "uds"}
              </div>
            </div>
            ...
            >
              ...
              <div
                style={{ fontSize: "13px", fontWeight: 600, marginTop: "4px" }}
              >
                {product.category}
              </div>
            </div>
                ...
                <tbody>
                  {!product.batches || product.batches.length === 0 ? (
                    <tr>
                      ...
                      >
                        No hay lotes con fecha de caducidad registrados para
                        este SKU.
                      </td>
                    </tr>
                  ) : (
                    product.batches.map((b, i) => (
                      <tr key={b.id || i}>
                        ...
                        <td>
                          <span
                            className={`badge ${b.daysRemaining <= 15 ? "badge-danger" : b.daysRemaining <= 30 ? "badge-warning" : "badge-info"}`}
                          >
                  ...
                  {!product.movements || product.movements.length === 0 ? (
                    ...
                    product.movements.map((m, i) => (
                      <tr key={m.id || i}>
                        ...
                        <td>
                          <span
                            className={`badge ${m.type === "Entrada" ? "badge-success" : "badge-info"}`}
                          >
                            {m.type}
                          </span>
                        </td>
